...
data_benthic %>% 
  ...
  ggplot(data = ., aes(x = date, y = cover, fill = category)) +
    ...
    geom_vline(xintercept = as.Date("2015-12-05"), color = "red", linetype = "dashed") +
    geom_vline(xintercept = as.Date("2009-12-05"), color = "red", linetype = "dashed") +
