...
data_hcc <- data_benthic %>% 
  ...
  group_by(replicate, site, island, year) %>% 
...
ggplot() +
  geom_point(data = data_hcc, aes(x = year, y = cover), col = "grey") +
  geom_pointrange(data = data_hcc_mean, 
                  aes(x = year, 
                      y = cover_mean, 
                      ymin = cover_mean-cover_sd, 
                      ymax = cover_mean+cover_sd), col = "red") +
  geom_path(data = data_hcc_mean, aes(x = year, y = cover_mean), col = "red") +
  facet_wrap(~island, nrow = 3) +
...
plot_grid(plotlist = c(plot_data_sst$plots[1:7], plot_data_sst_mmm$plots[1:7]), nrow = 2)
ggsave("./../figs/04_combined-plots-sst-hcc_1.png", height = 10, width = 25) # PNG

plot_grid(plotlist = c(plot_data_sst$plots[8:14], plot_data_sst_mmm$plots[8:14]), nrow = 2)
ggsave("./../figs/04_combined-plots-sst-hcc_2.png", height = 10, width = 25) # PNG

plot_grid(plotlist = c(plot_data_sst$plots[15:21], plot_data_sst_mmm$plots[15:21]), nrow = 2)
ggsave("./../figs/04_combined-plots-sst-hcc_3.png", height = 10, width = 25) # PNG
